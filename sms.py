...
def toplevel_data(title,button_text,command):
    ...
    genderEntry = ttk.Combobox(screen, font=('roman', 15, 'bold'), width=24)
...
def connect_database():
    def connect():
        ...
        try:
            ...
            con = pymysql.connect(host='localhost', user='root', password='Jaykay7!')
            mycursor=con.cursor()
        except:
...
attendanceButton=ttk.Button(root,text='Attendance')
attendanceButton.place(x=980,y=35)
